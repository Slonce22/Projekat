...
<br><br>
              <form id="form" class="form-horizontal" method="POST" action="update.php?knjigaID=<?php echo "$k->knjigaID";?>">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="knjigaCena" placeholder="Unesite cenu..." id="knjigaCena" value="<?php echo "$k->knjigaCena";?>">
                    </div>
                  </div>
          ...
          <div class="col-sm-2">
            <img src="img/b4.jpg" alt="books" height="300px"/>
            <br><br>
        </div>
