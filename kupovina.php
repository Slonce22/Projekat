       ...
       <br>
              ...
              if (isset($_SESSION['username']) && !empty($_SESSION['username'])) {
                          if($_SESSION['status']=='Admin'){
                                                echo " <td><button class='btn btn-primary disabled'>Rezervisi</button></td>
                                             </tr>";
                                     }
                              ...
                              foreach($odgovorOdServisa->kupovina as $kupovina) {
                                ...
                                if($kupovina->knjigaID==$knjiga->knjigaID){
                                  ...
                                  if($dugme==0){
                                    ...
                                    echo " <td><a href='ubaciKupovinu.php?knjigaID=". $knjiga->knjigaID ."'><button  class='btn btn-primary'>Rezervisi</button></a></td>
                                             </tr>";
